  ...
  <div class="container">
    <div class="section">
      <div class="column is-6 is-offset-3">
        <center>
          <h1 class="title" style="padding-top: 20px">BeatyBelle Installation</h1><br>
        </center>
        <div class="box">
          <?php
switch ($step) {
...
if ($_POST && isset($_POST["dbscs"])) {
            ...
            ?>
                ...
                <form action="#" id="admin-detal-form" method="POST">
                  <div class="field">
                    ...
                    <div class="control">
                      <input class="input" value="admin@admin.com" type="email" id="email" placeholder="Enter your admin username" name="email" required readonly>
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <input class="input" readonly value="secret" type="text" id="password" placeholder="Enter your admin password" name="password" required>
  ...
  <div class="content has-text-centered">
    <p>© <?php echo date('Y'); ?> Copyright BeatyBelle by SaaSMonks</p><br>
  </div>
</body>
